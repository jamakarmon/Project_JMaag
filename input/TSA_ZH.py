...
df_search['ind_orig'] = df_search['ZH']
df_search['ind_ma'] = df_search.rolling(window=7)['ZH'].mean()
...
pickle.dump(wintrendmodel[0], open(out_dir + 'ZH/trend_model.sav', 'wb'))
...
pickle.dump(error, open(out_dir + 'ZH/error_model.sav', 'wb'))
